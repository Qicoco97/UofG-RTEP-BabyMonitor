/****************************************************************************
** Meta object code from reading C++ file 'motionworker.h'
**
...
#error "The header file 'motionworker.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 14), // "motionDetected"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "detected"
QT_MOC_LITERAL(4, 38, 12), // "processFrame"
QT_MOC_LITERAL(5, 51, 7), // "cv::Mat"
QT_MOC_LITERAL(6, 59, 5) // "frame"

    },
    "MotionWorker\0motionDetected\0\0detected\0"
    "processFrame\0cv::Mat\0frame"
};
...
void MotionWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->motionDetected((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MotionWorker::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotionWorker::motionDetected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MotionWorker::motionDetected(bool _t1)
{
