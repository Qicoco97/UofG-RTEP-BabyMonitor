...
| File | Description |
|------|-------------|
| `project_log.md` | Project development log: timeline, key tasks, milestones |
| `system_architecture.md` | System architecture: description of hardware & software modules (camera, GUI, DHT11, DDS communication, etc.) |
| `end_of_life.md` | Project reflection: limitations, issues, and future improvements |
| `credits.md` | Team member responsibilities: listing contributions of each member |
